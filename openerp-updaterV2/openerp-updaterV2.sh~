...
local MILESTONES1=$(bzr tags | cut -d" " -f1 | grep ^$OPENERPSERIES |tr -d \n 2> /dev/null)
...
local MILESTONE=$(dialog --stdout --menu "Which $branch4 release or revision would you like to update to?" 25 80 ${#MILESTONES3[@]} "${array[@]}" 2> $tempfile)
...
openerp-server: ${LOCALREVISIONPERBRANCH[openerp-server]}\n
openerp-client: ${LOCALREVISIONPERBRANCH[openerp-client]}\n
openerp-web: ${LOCALREVISIONPERBRANCH[openerp-web]}\n
addons: ${LOCALREVISIONPERBRANCH[addons]}\n
extra-addons: ${LOCALREVISIONPERBRANCH[extra-addons]}\n\n
LATEST REVISIONS AVAILABLE ON LAUNCHPAD (Remote Parent Tree):\n
openerp-server: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-server]}\n
openerp-client: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-client]}\n
openerp-web: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-web]}\n
addons: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[addons]}\n
extra-addons: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[extra-addons]}\n\n
...
echo "openerp-server: ${LOCALREVISIONPERBRANCH[openerp-server]}">>$MYDESKTOP/OpenERP-updates.txt
echo "openerp-client: ${LOCALREVISIONPERBRANCH[openerp-client]}">>$MYDESKTOP/OpenERP-updates.txt
echo "openerp-web: ${LOCALREVISIONPERBRANCH[openerp-web]}">>$MYDESKTOP/OpenERP-updates.txt
echo "addons: ${LOCALREVISIONPERBRANCH[addons]}">>$MYDESKTOP/OpenERP-updates.txt
echo "extra-addons: ${LOCALREVISIONPERBRANCH[extra-addons]}">>$MYDESKTOP/OpenERP-updates.txt
echo >>$MYDESKTOP/OpenERP-updates.txt
echo "LATEST REVISIONS AVAILABLE ON LAUNCHPAD (Remote Tree): ">>$MYDESKTOP/OpenERP-updates.txt
echo "openerp-server: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-server]} ">>$MYDESKTOP/OpenERP-updates.txt
echo "openerp-client: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-client]} ">>$MYDESKTOP/OpenERP-updates.txt
echo "openerp-web: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[openerp-web]} ">>$MYDESKTOP/OpenERP-updates.txt
echo "addons: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[addons]} ">>$MYDESKTOP/OpenERP-updates.txt
echo "extra-addons: ${LATESTREVISIONAVAILABLEONLAUNCHPADPERBRANCH[extra-addons]} ">>$MYDESKTOP/OpenERP-updates.txt
echo >>$MYDESKTOP/OpenERP-updates.txt
