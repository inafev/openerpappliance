...
$DIALOG --backtitle "$background" \
        ...
        --mixedgauge "OpenERP-updates.txt file is created with records of installed or updated OpenERP revisions.\nThis is useful to be in control of your updates" \
                0 0 $i \
...
$DIALOG --title "OpenERP updater" --clear \
        --msgbox "OpenERP has been updated and restarted\n\nOpenERP-updates.txt file is created with records of installed or updated OpenERP revisions.\nThis is useful to be in control of your updates\n\nPress OK to exit" 15 60
case $? in
  0)
    #echo "OK"
    ;;
