...
check4newrevisionsfunc NEWREVISIONSFOUND LISTBRANCHES | dialog --progressbox "Checking for new OpenERP revisions" 6 70 0
...
sudo bzr update /home/openerp/production/openerp-server >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo -v
fi
...
cd /home/openerp/production/openerp-client
sudo bzr pull --overwrite >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo bzr update /home/openerp/production/openerp-client >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo -v
fi
...
cd /home/openerp/production/openerp-web
sudo bzr pull --overwrite >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo bzr update /home/openerp/production/openerp-web >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo -v
fi
...
cd /home/openerp/production/addons
sudo bzr pull --overwrite >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo bzr update /home/openerp/production/addons >>$MYDESKTOP/OpenERP-updates.txt 2>&1
sudo -v
fi
...
then
   ...
   cd /home/openerp/production/extra-addons
   sudo bzr pull --overwrite >>$MYDESKTOP/OpenERP-updates.txt 2>&1
   sudo bzr update /home/openerp/production/extra-addons >>$MYDESKTOP/OpenERP-updates.txt 2>&1
...
sudo cp -ru /home/openerp/production/addons/* $ADDONSPATH
...
sudo cp -ru /home/openerp/production/extra-addons/* $ADDONSPATH
sudo chown -R openerp.root $ADDONSPATH
sudo chmod 755 $ADDONSPATH
fi
